 ...
 */
import { AuthenticationError, ControlFileError, ForbiddenError, NetworkError, NotFoundError, QuotaExceededError, ServerError, ValidationError, } from '../errors.js';
...
export class HttpClient {
    ...
    async call(path, init = {}, requireAuth = true) {
    ...
    async handleErrorResponse(response) {
        ...
        switch (response.status) {
            ...
            case 413:
                return new QuotaExceededError(message, errorData.usedBytes, errorData.pendingBytes, errorData.planQuotaBytes, errorData.requiredBytes, errorData);
            case 500:
            case 502:
            case 503:
            case 504:
